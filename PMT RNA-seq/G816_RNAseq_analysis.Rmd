...
ggsave("DEA-genes_TGF+TNF.png", width = 6, height = 6)
...
ggsave("DEA-genes_TGF+TNF_verhaak.png", width = 6, height = 6)
...
```{r plot GSVA results for TGF vs Unt samples}
